    ...
    <div className="searchbar">
      ...
      {canSearch && (
        <div className="popover open">
          <div className="popover-head"><span>{q ? 'Backend search results' : 'Default outputs from backend'}</span></div>
          <div>
